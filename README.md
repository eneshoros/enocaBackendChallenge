...
Bu proje, Enoca tarafından sunulan backend programlama challenge için geliştirilmiştir. Proje, Java dilinde Spring Boot ve Maven kullanılarak geliştirilmiş olup, PostgreSQL veritabanıyla entegre edilmiştir.
